...
export function getSpecificContent(value) {
  console.log("original: ", [value[0]]);
  return [value[0]];
}
...
export function changeStyle(theme) {
  ...
  if (theme == 'CSK_Style'){
    ...
    var customBackground =  `.CSK_Module_Dashboard .myCustomBackground_CSK_Module_Dashboard { background-color: #737F8522; }` // font-family: "Open Sans"; }`
    ...
    var customBackground =  `.CSK_Module_Dashboard .myCustomBackground_CSK_Module_Dashboard { background-color: #fff; }` // font-family: "sans-serif"; }`
